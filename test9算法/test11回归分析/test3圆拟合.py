...
if __name__ == '__main__':
  ...
  circle1 = hyper_fit(data)
  print(circle1)

  circle2 = least_squares_circle(data)
  print(circle2)

  plot_data_circle(*list(zip(*data)), circle1[0], circle1[1], circle1[2])
  plot_data_circle(*list(zip(*data)), circle2[0], circle2[1], circle2[2])
